...
class MailingKeyboards:
    ...
    async def back_to_admin_keyboard(self, as_markup=True):
        ...
        kb.button(text=b.Back.back_to_admin, callback_data="pass")
        return kb.as_markup() if as_markup else InlineKeyboardButton(text=b.Back.back_to_admin, callback_data="pass")
    ...
    async def back_to_mailing_keyboard(self, as_markup=True):
        ...
        return kb.as_markup() if as_markup else InlineKeyboardButton(
            text=b.Back.back_to_mailing, callback_data=d.Back.back_to_mailing
        )
    ...
    async def mailing_menu_keyboard(self, is_media: bool = False, is_video_note: bool = False):
        ...
        disable_webpage_preview = InlineKeyboardButton(
            text=b.Menu.disable_webpage_preview, callback_data=d.Menu.disable_webpage_preview
        )
